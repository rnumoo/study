...
public class CommonInterceptor extends HandlerInterceptorAdapter {
    ...
    public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
        ...
        /**
         * if (RequestContextHolder.getRequestAttributes() == null) { isAuthenticated =
         * false; } else { if
         * (RequestContextHolder.getRequestAttributes().getAttribute("userLoginVO",
         * RequestAttributes.SCOPE_SESSION) == null) { isAuthenticated = false; } else {
